...
const Template1 = () => {
  return (
    <>
      <section className="flex h-[8%] w-full items-center justify-between bg-enfasis p-2 font-anton text-3xl text-white shadow-xl">
        <img src={logoCij} className="h-full" />
        <span>Operacion X</span>
        <img src={logoMpf} className="h-full" />
      </section>
      <section id="blank" className="h-[2%]"></section>
      <main className="grid  h-[90%] gap-2 overflow-y-scroll bg-base p-2 sm:grid-cols-2  md:grid-cols-3 md:gap-4 xl:grid-cols-4 2xl:grid-cols-6">
        ...
        <section className="templateSections enfasisBorders p-0 md:row-span-2 xl:row-span-4 2xl:hidden">
